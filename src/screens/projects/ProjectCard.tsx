...
export const ProjectCard = () => {
  return (
    <div className="mt-4 w-[98%] hover:cursor-pointer rounded-lg border-1 border-themePrimaryColor shadow-technologiesCard pb-4">
      <img
        src="./src/assets/images/cf-logo.webp"
      ...
      <p className="text-primaryColor text-base p-4">
        Platform streamlines fundraising and community management for education
        and healthcare sectors. Create branded, mobile-optimized pages
        effortlessly and manage initiatives seamlessly. The platform integrates
        directly with your brand, website, and existing payment processor. Ideal
        for inspiring donors and building engaged communities.
      </p>
    </div>
  );
};

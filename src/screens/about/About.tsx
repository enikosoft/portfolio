  ...
  return (
    <div className="overflow-hidden h-auto w-full flex items-center text-primaryColor">
      <div className="w-full xl:w-2/3">
        ...
        <h1 className="font-bold text-primaryColor opacity-70 pl-10 text-3xl sm:text-5xl pb-2">Hello,</h1>

        <span className="html-tag pl-8">{'</h1>'}</span>
        <br />
        <span className="html-tag pl-8">{'<p>'}</span>
        <p className="pl-10 pb-4 text-lg">
          My name is <span className="text-themePrimaryColor text-lg">Evgen Nikolenko</span> and I am an experienced{' '}
          <span className="text-themePrimaryColor text-lg">Full-Stack JavaScript Developer </span>
          with over 6 years of expertise in building web applications using{' '}
          <span className="text-themePrimaryColor text-lg">React and Node.js</span> technologies.
        </p>
        <p className="pl-10 pb-4 text-lg">
      ...
      {!mobileAndTablet && <div className="bg-cover bg-about w-[300px] h-[300px] sm:w-[400px] sm:h-[400px]"></div>}
    </div>
  );
};
